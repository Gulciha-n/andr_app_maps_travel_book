...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback , GoogleMap.OnMapLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = MapsActivity.this.getSharedPreferences("com.example.mapsjava",MODE_PRIVATE);
        info = false;
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        if (intentInfo.equals("new")){
            ...
            locationListener = new LocationListener() {  //interface
                @Override
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.ACCESS_FINE_LOCATION)) {
                    Snackbar.make(binding.getRoot(), "Permission needed", Snackbar.LENGTH_INDEFINITE).setAction("Give permission", new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            //request permission - ActivityResultLauncher
            ...
            if (selectedPlace != null){
                ...
                Toast.makeText(this, "Selected place is null", Toast.LENGTH_SHORT).show();
    ...
    public void onDestroy(){
        super.onDestroy();
        compositeDisposable.clear();  //// Aboneliği iptal et
    }
}
